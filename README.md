...
- [ ] Explain what a token is used for.
   ...
   A token is used for authenticating a user. 

- [ ] What steps can you take in your web apps to keep your data secure?

   Creating private routes so only authorized/authenticated users can access certain information. 

- [ ] Describe how web servers work.

A web server processes incoming network requests over HTTP and other related protocols. The primary function of a web server is to store, process, and deliver web pages to clients. The communication between clinet and server takes place using the HTTP. 
